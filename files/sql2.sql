...
CREATE TABLE IF NOT EXISTS `pre-projet`.`demandes` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_demandes_events_idx` (`events_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`actors` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_actors_demandes1_idx` (`demandes_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `mydb`.`displacements`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`displacements` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  `demandes_id` INT(11) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_displacements_demandes1_idx` (`demandes_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `mydb`.`materiaux`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`materiaux` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  ...
  `demandes_id` INT(11) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_materiaux_demandes1_idx` (`demandes_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`location` (
  ...
  `demandes_id` INT(11) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_location_demandes1_idx` (`demandes_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`tickets` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_tickets_demandes1_idx` (`demandes_id` ASC) VISIBLE,
  INDEX `fk_tickets_categories1_idx` (`categories_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`sells` (
  ...
  `users_id` INT(11) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_sells_tickets1_idx` (`tickets_id` ASC) VISIBLE,
  INDEX `fk_sells_users1_idx` (`users_id` ASC) VISIBLE,
